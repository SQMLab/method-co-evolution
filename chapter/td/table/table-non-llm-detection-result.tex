...
\multirow{17}{*}{\rotatebox[origin=c]{45}{Original}}
  ...
  & DebtHunter~\cite{sala_debthunter_2021} & \xmark & \xmark    &   0.26 & 0.58 & 0.36 & 0.38\\
  & DebtHunter~\cite{sala_debthunter_2021} & \checkmark & \xmark    &   0.53 & 0.65 & 0.59 & 0.58\\
  & DebtHunter~\cite{sala_debthunter_2021} & \checkmark & \checkmark    &   0.68 & 0.69 & 0.68 & 0.68\\
  & \textit{Minimum} & -- & -- & 0.09 & 0.03 & 0.06 & 0.15\\
  & \textit{Maximum} & -- & -- & 0.95 & 0.88 & 0.75 & 0.76\\
  & \textit{Average} & -- & -- & 0.52 & 0.59 & 0.47 & 0.49\\
\midrule
\multirow{17}{*}{\rotatebox[origin=c]{45}{Deduplicate}}
  ...
  & SATD Detector~\cite{liu_satd_2018} & \checkmark & \checkmark    &   0.36 & 0.65 & 0.46 & 0.47\\
  ...
  & DebtHunter~\cite{sala_debthunter_2021} & \xmark & \xmark    &   0.34 & 0.53 & 0.41 & 0.41\\
  & DebtHunter~\cite{sala_debthunter_2021} & \checkmark & \xmark    &   0.21 & 0.65 & 0.32 & 0.35\\
  & DebtHunter~\cite{sala_debthunter_2021} & \checkmark & \checkmark    &   0.47 & \textbf{0.69} & 0.54 & \added{0.55}\\
  & \textit{Minimum} & -- & -- & 0.14 & 0.04 & 0.07 & 0.17\\
  & \textit{Maximum} & -- & -- & 0.95 & 0.69 & 0.70 & 0.73\\
  & \textit{Average} & -- & -- & 0.50 & 0.54 & 0.46 & 0.48\\
\bottomrule
\end{tabular}
