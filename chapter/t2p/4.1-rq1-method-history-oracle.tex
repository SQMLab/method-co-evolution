...
\input{figure/method-history-runtime-table}
...
Considering both accuracy and runtime, \emph{HistoryFinder} is the best tool for tracking test method change history. Overall, our results are encouraging, as they suggest researchers can use existing tools directly without the cost of retraining them for test methods.
\end{framed}
