...
class TestMethodLinkPromptFactory(unittest.TestCase):
    def test_t2p_prompt_contains_real_commons_io_methods(self):
        ...
        self.assertIn("Production methods called by this test method:", prompt.prompt_text)
    ...
    def test_p2t_prompt_contains_real_commons_io_methods(self):
        ...
        self.assertIn("Test methods that call this production method:", prompt.prompt_text)
        self.assertIn(
